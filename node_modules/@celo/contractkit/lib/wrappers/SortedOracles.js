 ...
 * @param pair a string
 */
exports.pairIdentifier = function (pair) {
    return base_1.ensureLeading0x(ethereumjs_util_1.keccak256(pair)
        .slice(0, 20)
        .toString('hex'));
};
exports.OracleCurrencyPair = {
    CELOBTC: exports.pairIdentifier('CELO/BTC'),
    CELOUSD: base_2.CeloContract.StableToken,
};
/**
 * Disambiguate a ReportTarget to a CeloToken
 * @param target ReportTarget
 */
var isCeloToken = function (target) {
    return target === base_2.CeloContract.StableToken || target === base_2.CeloContract.GoldToken;
};
/**
...
var SortedOraclesWrapper = /** @class */ (function (_super) {
    ...
    function SortedOraclesWrapper() {
        ...
        _this.getStableTokenRates = function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, this.getRates(base_2.CeloContract.StableToken)
                /**
    ...
    SortedOraclesWrapper.prototype.reportStableToken = function (value, oracleAddress) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.report(base_2.CeloContract.StableToken, value, oracleAddress)];
            });
        });
    };
    /**
